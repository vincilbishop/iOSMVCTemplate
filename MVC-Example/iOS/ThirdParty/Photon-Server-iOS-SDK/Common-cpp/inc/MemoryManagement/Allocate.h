...
#include <new>
#include "Common-cpp/inc/MemoryManagement/Internal/MemoryPoolManager.h"
...
#define EG_MALLOC  ExitGames::Common::MemoryManagement::Internal::MemoryPoolManager::get().alloc
...
#define EG_FREE    ExitGames::Common::MemoryManagement::Internal::MemoryPoolManager::get().dealloc
...
/** @def EG_REALLOC
   ...
   If a passed non-NULL address has not previously been returned by EG_MALLOC() or EG_REALLOC(), then the behavior is undefined. */
#define EG_REALLOC ExitGames::Common::MemoryManagement::Internal::MemoryPoolManager::get().resize
